import{e as M,r as h,w as fr,R as $t,t as pr,a as xt,f as he,y as hr,j as x,z as Bt,C as be,Q as mr,D as gr,p as vr,L as br,E as xr,F as Er,G as Cr}from"./index-a6c04152.js";import{S as yr}from"./Section-9c123e36.js";import{T as Sr}from"./Text.styled-d4c8ace4.js";import{s as ft}from"./sprite-e09aa1c4.js";import{F as wr}from"./Form-ba4fdbb8.js";import"./Fieldset.styled-7209ef31.js";/* empty css                         */import{e as Ce,a as bn,h as Fr,_ as Or,b as Ar,c as Dr,d as Ir,g as Mr}from"./defineProperty-179e1ab7.js";import{B as jt,A as Pr,E as Vr}from"./BasicModalWindow-b4fe9315.js";import{c as Rr}from"./selectors-6efb1357.js";import{T as Ht}from"./Text-a77ad1b4.js";import{C as kr}from"./Loader-a507a64c.js";const Lr="/fs-86-react-node-kurshatsov-andrii/assets/products-1x-60ae029e.jpg",Tr="/fs-86-react-node-kurshatsov-andrii/assets/products-2x-88f016c5.jpg",zt="/fs-86-react-node-kurshatsov-andrii/assets/products-tablet-2x-d8bdd0d5.jpg",Nt="/fs-86-react-node-kurshatsov-andrii/assets/products-mobil-2x-b29d44f2.jpg",$r=M.div`
  display: flex;
...
`,Xs=({id:t,productName:e,calories:r,onClick:i,onClickSuccess:n,transferCaloriesAmount:o})=>{const s=xt(),[l,a]=h.useState(""),u=Math.round(l*r/100),c={position:"top-center",autoClose:2e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"dark"},d=he(Rr),g={productId:t,amount:l,date:d},v=f=>{if(f.preventDefault(),u<=0){a(""),mr.error("Weight must be greater than 0",c);return}s(gr(g)).unwrap().then(()=>s(vr)).catch(p=>console.log(p)),i(),n(),o(u)},b=()=>{i()};return x.jsx($s,{children:x.jsxs(Bs,{children:[x.jsx(js,{children:x.jsx(Hs,{type:"text",value:e,name:"productName",disabled:!0})}),x.jsxs(zs,{children:[x.jsx(Ns,{type:"number",value:l,name:"productQuantity",onChange:f=>a(f.target.value),placeholder:"0"}),x.jsx(_s,{children:"grams"})]}),x.jsxs(Us,{children:[x.jsx(Ws,{children:"Calories:"}),x.jsx(Gs,{children:u})]}),x.jsxs(Ys,{children:[x.jsx(qs,{type:"submit",onClick:v,children:"Add to diary"}),x.jsx(Ks,{type:"button",onClick:b,children:"Cancel"})]})]})})},Qs="/fs-86-react-node-kurshatsov-andrii/assets/avocado-832d00b1.png",Zs=M.div`
  padding: 48px 75px;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,gu=({id:t,weight:e,calories:r,category:i,title:n,isRecomended:o})=>{const[s,l]=h.useState(!1),[a,u]=h.useState(!1),c=()=>{l(f=>!f)},d=()=>{u(f=>!f)},[g,v]=h.useState(""),b=f=>{v(f)};return x.jsxs(x.Fragment,{children:[s&&x.jsx(jt,{onClick:c,children:x.jsx(Xs,{id:t,productName:n,calories:r,onClick:c,onClickSuccess:d,transferCaloriesAmount:b})}),a&&x.jsxs(jt,{onClick:d,children:[x.jsx(su,{onClick:d,calories:g})," "]}),x.jsxs("div",{children:[x.jsxs(uu,{children:[x.jsx(lu,{children:x.jsx("p",{children:"Diet"})}),x.jsxs(cu,{children:[x.jsx(xr,{shouldForwardProp:Er,children:x.jsxs(du,{recommendation:o,children:[x.jsx("div",{}),x.jsx("p",{children:o?"Recommended":"Not recommended"})]})}),x.jsxs(fu,{type:"button",onClick:c,children:["Add",x.jsx(Pr,{})]})]})]}),x.jsxs(pu,{children:[x.jsx("div",{children:x.jsx(Vr,{})}),x.jsx("p",{children:n})]}),x.jsxs(hu,{children:[x.jsx("li",{children:x.jsxs("p",{children:["Calories:",x.jsx("span",{children:r})]})}),x.jsx("li",{children:x.jsxs(mu,{children:["Category:",x.jsx("span",{children:i})]})}),x.jsx("li",{children:x.jsxs("p",{children:["Weight:",x.jsx("span",{children:e})]})})]})]})]})},vu=M.ul`
  margin-top: 40px;
  display: flex;
  flex-direction: column;
  gap: 20px;
...
`,Tu=()=>x.jsxs(yr,{backgrounds:{desctop:Lr,desctopretina:Tr,tablet:zt,tabletretina:zt,mobil:Nt,mobilretina:Nt},children:[x.jsx(Su,{children:x.jsx(Sr,{tag:"h1",size:"h3",children:"Products"})}),x.jsx(Ts,{}),x.jsx(yu,{})]});export{Tu as default};
